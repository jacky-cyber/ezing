...
{
    UIMenuItem *undo = [[UIMenuItem alloc] initWithTitle:NSLocalizedString(@"撤销", nil) action:@selector(slk_undo:)];
    UIMenuItem *redo = [[UIMenuItem alloc] initWithTitle:NSLocalizedString(@"重做", nil) action:@selector(slk_redo:)];
    UIMenuItem *format = [[UIMenuItem alloc] initWithTitle:NSLocalizedString(@"格式化", nil) action:@selector(slk_presentFormattingMenu:)];
